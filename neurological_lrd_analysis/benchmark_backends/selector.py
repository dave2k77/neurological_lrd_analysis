...
def check_jax_availability() -> Dict[str, bool]:
    ...
    jax_info = {"available": False, "gpu_available": False, "tpu_available": False}
...
def check_numba_availability() -> Dict[str, bool]:
    ...
    numba_info = {"available": False, "cuda_available": False}
...
def recommend_backend(
    data_size: int, use_case: str = "general", **kwargs
) -> Dict[str, Any]:
    """
    ...
    **kwargs
    ...
    if data_size < 1000:
        ...
        recommendation["reasoning"].append(
            "Large data size benefits from GPU acceleration"
        )
