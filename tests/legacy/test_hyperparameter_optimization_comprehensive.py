...
class TestLazyImports:
    ...
    @patch('neurological_lrd_analysis.ml_baselines.hyperparameter_optimization.optuna', None)
    ...
    @patch('neurological_lrd_analysis.ml_baselines.hyperparameter_optimization.sklearn', None)
...
class TestOptunaOptimizer:
    ...
    def test_optimizer_optimize_basic(self):
        ...
        optimizer = OptunaOptimizer(n_trials=5, timeout=10)
        ...
        with patch.object(optimizer, '_create_objective') as mock_objective:
            mock_objective.return_value = lambda trial: 0.5
    ...
    def test_optimizer_optimize_with_custom_params(self):
        """Test optimization with custom parameters."""
        optimizer = OptunaOptimizer(n_trials=3, timeout=5)
        ...
        with patch.object(optimizer, '_create_objective') as mock_objective:
            mock_objective.return_value = lambda trial: 0.6
    ...
    def test_optimizer_optimize_invalid_estimator(self):
        """Test optimization with invalid estimator type."""
        optimizer = OptunaOptimizer(n_trials=2, timeout=5)
    ...
    def test_optimizer_optimize_empty_data(self):
    ...
    def test_optimizer_optimize_mismatched_data(self):
...
class TestCreateOptunaStudy:
    ...
    def test_create_optuna_study_invalid_sampler(self):
        ...
        with pytest.raises(ValueError):
            create_optuna_study(sampler_type="invalid_sampler")
    
    def test_create_optuna_study_invalid_pruner(self):
        """Test study creation with invalid pruner."""
        with pytest.raises(ValueError):
            create_optuna_study(pruner_type="invalid_pruner")
...
class TestOptimizeHyperparameters:
    ...
    def test_optimize_hyperparameters_with_validation_split(self):
        """Test optimization with validation split."""
        X = np.random.randn(100, 10)
        y = np.random.randn(100)
    ...
    def test_optimize_hyperparameters_with_custom_params(self):
        """Test optimization with custom parameters."""
        X = np.random.randn(100, 10)
        y = np.random.randn(100)
...
class TestOptimizeAllEstimators:
    ...
    def test_optimize_all_estimators_with_validation_split(self):
        """Test optimization with validation split."""
        X = np.random.randn(100, 10)
        y = np.random.randn(100)
    ...
    def test_optimize_all_estimators_with_custom_params(self):
        """Test optimization with custom parameters."""
        X = np.random.randn(100, 10)
        y = np.random.randn(100)
        
        custom_params = {
            'random_forest': {'n_estimators': [10, 20]},
            'svr': {'C': [0.1, 1.0]}
        }
...
class TestCreateOptimizedEstimators:
    ...
    def test_create_optimized_estimators_with_validation_split(self):
        """Test creation with validation split."""
        X = np.random.randn(100, 10)
        y = np.random.randn(100)
    ...
    def test_create_optimized_estimators_with_custom_params(self):
...
class TestErrorHandling:
    ...
    def test_optimizer_with_invalid_data_types(self):
        """Test optimizer with invalid data types."""
        optimizer = OptunaOptimizer(n_trials=2, timeout=5)
    ...
    def test_optimizer_with_nan_data(self):
        """Test optimizer with NaN data."""
        optimizer = OptunaOptimizer(n_trials=2, timeout=5)
    ...
    def test_optimizer_with_inf_data(self):
        """Test optimizer with infinite data."""
        optimizer = OptunaOptimizer(n_trials=2, timeout=5)
